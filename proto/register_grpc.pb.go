...
const (
	RegisterUser_RegisterUser_FullMethodName = "/proto.RegisterUser/RegisterUser"
)
...
func (c *registerUserClient) RegisterUser(ctx context.Context, in *RegisterUserRequest, opts ...grpc.CallOption) (*RegisterUserResponse, error) {
...
func (UnimplementedRegisterUserServer) RegisterUser(context.Context, *RegisterUserRequest) (*RegisterUserResponse, error) {
...
var RegisterUser_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "proto.RegisterUser",
